...
// Main register_technician function
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Function to validate the technician registration form
  async function validateRegisterTechnicianForm(event) {
    ...
    try {
      ...
      const response = await fetch('/register_technician', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  form.addEventListener('submit', validateRegisterTechnicianForm);
});
