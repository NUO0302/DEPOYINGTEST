document.addEventListener('DOMContentLoaded', () => {
  ...
  document.addEventListener("DOMContentLoaded", function () {
   ...
   /* var removeReservationMenu = document.getElementById("remove-reservation-menu");
    
    if (tecStatus === "1" || currentUser === "admin@dlsu.edu.ph") {
      removeReservationMenu.style.display = "block";
    } else {
      removeReservationMenu.style.display = "none";
    } */
